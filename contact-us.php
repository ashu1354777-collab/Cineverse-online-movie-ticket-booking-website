...
<body>
    ...
    <div class="contact-us-container">
        <div class="contact-us-section contact-us-section1">
            ...
            <form action="" method="POST">
                ...
                if (isset($_POST['submit'])) {
                    $stmt = mysqli_prepare($con, "INSERT INTO feedbackTable (senderfName, senderlName, sendereMail, senderfeedback) VALUES (?, ?, ?, ?)");
                    mysqli_stmt_bind_param($stmt, "ssss", $_POST["fName"], $_POST["lName"], $_POST["eMail"], $_POST["feedback"]);
        ...
        <div class="contact-us-section contact-us-section2">
            <h1>Address & Info</h1>
            <h3>Phone Numbers</h3>
            <p><a href="tel:01011391148">+91 1800500354</a><br>
                <a href="tel:01011391148">+91 1800500355</a></p>
            <h3>Address</h3>
            <p>Skymark, Floor No. 6th to 22nd, Plot No. H-10B, Sector-98, Raipur Chhatisgarh India.</p>
            <h3>E-mail</h3>
