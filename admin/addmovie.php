                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align="center">
                                    ...
                                    <td><button value="Edit" type="submit" onclick="" type="button" class="btn btn-warning"><?php echo "<a href='editmovie.php?id=" . $row['movieID'] . "'>edit</a>"; ?></button>
                                        <button value="Delete" type="submit" onclick="" type="button" class="btn btn-danger"><?php echo "<a href='deletemovie.php?id=" . $row['movieID'] . "'>delete</a>"; ?></button>
                                    </td>
                                </tr>
                            <?php }
                            ?>
