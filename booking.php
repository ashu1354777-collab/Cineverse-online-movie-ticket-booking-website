...
$stmt = mysqli_prepare($con, "SELECT * FROM movieTable WHERE movieID = ?");
mysqli_stmt_bind_param($stmt, "i", $id);
mysqli_stmt_execute($stmt);
$movieImageById = mysqli_stmt_get_result($stmt);
        ...
        <div class="booking-panel-section booking-panel-section4">
            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <input placeholder="No. of Tickets" type="number" name="ticket_qty" min="1" max="10" value="1" required>
